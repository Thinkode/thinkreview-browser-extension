...
async function displayIntegratedReview(review, patchContent, patchSize = null, subscriptionTier = null) {
  ...
  if (patchSizeBanner) {
    try {
      ...
      metadataModule.renderReviewMetadataBar(patchSizeBanner, patchSize, subscriptionTier);
    } catch (error) {
