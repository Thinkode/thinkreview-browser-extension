export function getAgentIcon(className = '', width = '24', height = '24', style = '') {
  const classAttr = className ? `class="${className}"` : '';
  const styleAttr = style ? `style="${style}"` : '';
  return `<svg ${classAttr} width="${width}" height="${height}" ${styleAttr} viewBox="0 0 24 24" fill="currentColor">
