...
/**
 * Get cached server version for an origin (if any).
 ...
 * Only runs if the version for this origin is not already in extension storage; otherwise returns cached.
