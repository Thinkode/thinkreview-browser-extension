...
async function fetchAndDisplayCodeReview(forceRegenerate = false) {
  ...
  try {
    ...
    // Display the review results with patchSize and subscriptionType if available
    displayIntegratedReview(data.review, codeContent, data.patchSize, data.subscriptionType);
  } catch (error) {
