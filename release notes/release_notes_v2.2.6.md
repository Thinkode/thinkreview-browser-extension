# ThinkReview - Version 2.2.6 Release Notes
...
When a model needs longer to answer, the extension waits up to **two minutes** before treating the call as failed, so legitimate slow responses are less likely to cut off early. (Thank you @JElsheikh!)
